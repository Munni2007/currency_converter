...
Title = Label(root, text="Currency Convertor", fg="blue",  bg="gray", font=("ubuntu", 18, "bold"))
Title.place(x=170, y=10)

Lable1 = Label(root, text="Enter the Amount to Convert :- ", bg="gray", fg="brown", font=("ubuntu", 15, "bold"))
Lable1.place(x=15, y=60)

var1 = IntVar()
feeder = Entry(root, width=24 ,text=var1, bg="lightblue", fg="yellow", font=("ubuntu", 15, "bold"))
feeder.place(x=320, y=60)

Label2 = Label(root, text="Select the Currency to Convert Your Amount From :- ", bg="gray", fg="orange", font=("ubuntu", 10, "bold"))
...
Lable3 = Label(root, text="Select the Currency to Convert Your Amount To :-  ", bg="gray", fg="orange", font=("ubuntu", 10, "bold"))
...
Button1 = Button(root, bg="lightgreen", text="Convert", command=functionbutton , fg="black", font=("ubuntu", 15, "bold"), relief=RAISED,\
                            cursor="hand2")
Button1.place(x=240, y=220)

Label4 = Label(root, text="Converted Amount Here :- ", bg="gray", fg="brown", font=("ubuntu", 15, "bold"))
